    ...
    const renderBodySvg = (bodyToRender) => {
        ...
        {mergedBodyParts(bodyToRender).map((bodyPart) => {
                ...
                const commonPaths = (((_a = bodyPart.path) === null || _a === void 0 ? void 0 : _a.common) || []).map((path) => {
                    ...
                    return (<react_native_svg_1.Path key={path} onPress={isPartDisabled(bodyPart.slug) || !onBodyPartPress
                            ? undefined
                            : () => onBodyPartPress(bodyPart)} aria-disabled={isPartDisabled(bodyPart.slug)} id={bodyPart.slug} fill={fillColor !== null && fillColor !== void 0 ? fillColor : partStyles.fill} stroke={partStyles.stroke} strokeWidth={partStyles.strokeWidth} d={path}/>);
                });
                const leftPaths = (((_b = bodyPart.path) === null || _b === void 0 ? void 0 : _b.left) || []).map((path) => {
                    ...
                    return (<react_native_svg_1.Path key={path} onPress={isPartDisabled(bodyPart.slug) || !onBodyPartPress
                            ? undefined
                            : () => onBodyPartPress(bodyPart, "left")} id={bodyPart.slug} fill={fillColor !== null && fillColor !== void 0 ? fillColor : partStyles.fill} stroke={partStyles.stroke} strokeWidth={partStyles.strokeWidth} d={path}/>);
                });
                const rightPaths = (((_c = bodyPart.path) === null || _c === void 0 ? void 0 : _c.right) || []).map((path) => {
                    ...
                    return (<react_native_svg_1.Path key={path} onPress={isPartDisabled(bodyPart.slug) || !onBodyPartPress
                            ? undefined
                            : () => onBodyPartPress(bodyPart, "right")} id={bodyPart.slug} fill={fillColor !== null && fillColor !== void 0 ? fillColor : partStyles.fill} stroke={partStyles.stroke} strokeWidth={partStyles.strokeWidth} d={path}/>);
                });
